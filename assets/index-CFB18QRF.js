...
void main() {
    ...
    `,transparent:!0,depthWrite:!0,blending:yl});s=new bx(f,h),s.position.y=-3,i.add(s);const p=()=>{o=requestAnimationFrame(p),h.uniforms.time.value+=.02,s.rotation.y+=.001,s.rotation.x+=3e-4,t.render(i,r)};p(),window.addEventListener("resize",a)}),Vr(()=>{cancelAnimationFrame(o),window.removeEventListener("resize",a)});const a=()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)};return(l,c)=>(Ge(),ht("div",{ref_key:"canvasContainer",ref:e,class:"canvas-container"},null,512))}}),gy={class:"ball-container"},_y=Mt({__name:"BallTrack",props:{x:{},y:{},size:{}},setup(n){aa(t=>({d4cb3e84:e.y,d4cb3e86:e.x,"781edd9c":e.size}));const e=n;return(t,i)=>(Ge(),ht("div",gy))}}),Ut=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},vy=Ut(_y,[["__scopeId","data-v-65a6daa7"]]);class xy{constructor(e,t){at(this,"setAndReturn",e=>{const t=JSON.stringify(e);return localStorage.setItem(this.key,t),e});at(this,"read",()=>{const e=localStorage.getItem(this.key);return e?JSON.parse(e):this.setAndReturn(this._default)});at(this,"clear",()=>{localStorage.removeItem(this.key),this.setAndReturn(this._default)});this._default=e,this.key=t}}const es=new xy({dark:!0,swing:!0,trackBall:!0,opacity:64},"config"),Ls=gd("estado global",()=>{const n=Yt(es.read()),e=()=>{const o=Yt({isMobileSize:!1});return{status:o,metod:{handleMobileSize:()=>{o.isMobileSize=window.innerWidth<768}}}},t=()=>{const o=Yt({show:n.trackBall,size:"28px",x:"0px",y:"-50px"});return{status:o,metod:{trackBall:c=>{const u=o,f=parseFloat(u.size);u.x=`${c.clientX-f/2}px`,u.y=`${c.clientY-f/2}px`},show:c=>{o.show=c,n.trackBall=c,es.setAndReturn(n)}}}},i=()=>{const o=Yt({dark:n.dark});return{status:o,metod:{darkMode:l=>{o.dark=l,n.dark=l,es.setAndReturn(n)}}}},r=()=>{const o=Yt({swing:n.swing});return{status:o,metod:{swingMode:l=>{o.swing=l,n.swing=l,es.setAndReturn(n)}}}},s=()=>{const o=Yt({opacity:n.opacity});return{status:o,metod:{setOpacity:l=>{o.opacity=l,n.opacity=l,es.setAndReturn(n)}}}};return{trackBall:t(),darkMode:i(),swing:r(),opacity:s(),mobile:e()}}),My=Mt({__name:"App",setup(n){aa(u=>({"47cbc1a5":a.value}));const{trackBall:e,darkMode:t,opacity:i,mobile:r,swing:s}=Ls(),o=Bt(()=>t.status.dark),a=Bt(()=>i.status.opacity/100);return Xi(()=>r.status.isMobileSize,()=>{r.status.isMobileSize&&(e.status.show=!1,s.status.swing=!1)}),Tn(()=>{window.addEventListener("resize",r.metod.handleMobileSize)}),Vr(()=>{window.removeEventListener("resize",r.metod.handleMobileSize)}),(u,f)=>(Ge(),ht("div",{class:Xn(["main",!o.value&&"light-mode"]),onMousemove:f[0]||(f[0]=(...h)=>ot(e).metod.trackBall&&ot(e).metod.trackBall(...h))},[ot(i).status.opacity>0?(Ge(),Wt(my,{key:0,class:"idle"})):Cr("",!0),mt(ot(fa)),ot(e).status.show?(Ge(),Wt(vy,{key:1,x:ot(e).status.x,y:ot(e).status.y,size:ot(e).status.size,class:"ball-track"},null,8,["x","y","size"])):Cr("",!0)],34))}}),Sy=Mt({__name:"BoxBase",setup(n){aa(l=>({f9a92356:i.top,"3b82d9f2":i.left,"66309ac6":i.width,"4613c427":i.height,becab6a8:s.value,becab6aa:r.value}));const{swing:e}=Ls(),t={desktop:{left:"60px",top:"68px",width:"calc(100dvw - 60px * 2)",height:"calc(100dvh - 68px * 2)"},mobile:{left:"10px",top:"28px",width:"calc(100dvw - 10px * 2)",height:"calc(100dvh - 28px * 2)"}},i=Yt({...t.desktop}),r=xt("0deg"),s=xt("0deg"),o=()=>{window.innerWidth<768?Object.assign(i,t.mobile):Object.assign(i,t.desktop)},a=l=>{const c=window.innerHeight/2,u=window.innerWidth/2,f=l.clientX-u,h=l.clientY-c;r.value=`${f/-260}deg`,s.value=`${h/180}deg`};return Tn(()=>{o(),window.addEventListener("resize",o)}),Vr(()=>{window.removeEventListener("resize",o)}),(l,c)=>(Ge(),ht("div",{class:Xn(["box-container",{swing:ot(e).status.swing}]),onMousemove:a},[Io(l.$slots,"default",{},void 0)],34))}}),Ey=Ut(Sy,[["__scopeId","data-v-0db6a484"]]),yy=Mt({__name:"LinkBase",props:{toName:{},content:{}},setup(n){const e=n;return(t,i)=>{const r=Hh("RouterLink");return Ge(),Wt(r,{class:"link",to:{name:e.toName}},{default:Hr(()=>[od(sn(e.content),1)]),_:1},8,["to"])}}}),hc=Ut(yy,[["__scopeId","data-v-d73ca086"]]),by=n=>(ea("data-v-94226ccf"),n=n(),ta(),n),Ty={class:"left"},Ay=by(()=>Le("div",{class:"title"},[Le("h1",null,"Vinicius Silva"),Le("p",null,"Desevolvedor junior fullstack")],-1)),wy={class:"links"},Ry=Mt({__name:"HomePage",setup(n){const e=[{name:"Projetos",link:"Meus projetos"},{name:"Contatos",link:"Estou por ai"},{name:"Configurações",link:"Configurações"}];return(t,i)=>(Ge(),Wt(Ey,{class:"aboutme-container"},{default:Hr(()=>[Le("div",Ty,[Ay,Le("nav",wy,[(Ge(),ht(Dt,null,wr(e,(r,s)=>mt(hc,{class:"link",key:s,"to-name":r.link,content:r.name},null,8,["to-name","content"])),64))])])]),_:1}))}}),Cy=Ut(Ry,[["__scopeId","data-v-94226ccf"]]),Py={key:0,class:"desktop"},Dy={class:"left border-right"},Ly={class:"top"},Iy={class:"bottom border-top"},Uy={class:"list"},Ny={key:1,class:"mobile"},Fy={class:"top-mobile"},Oy={class:"mid-mobile"},ky={class:"bottom-mobile"},By=Mt({__name:"AureaTemplate",props:{title:{default:"Empty"},links:{}},setup(n){aa(h=>({"00ade270":s.top,"1515fe18":s.left,"8c702b0e":s.width,"65666ad4":s.height,"187f60ce":a.value,"187f60d0":o.value}));const{swing:e}=Ls(),t=n,i={desktop:{left:"60px",top:"68px",width:"calc(100dvw - 60px * 2)",height:"calc(100dvh - 68px * 2)"},mobile:{left:"10px",top:"28px",width:"calc(100dvw - 10px * 2)",height:"calc(100dvh - 28px * 2)"}},r=xt(!1),s=Yt({...i.desktop}),o=xt("0deg"),a=xt("0deg"),l=()=>{window.innerWidth<768?(r.value=!0,Object.assign(s,i.mobile)):(r.value=!1,Object.assign(s,i.desktop))},c=h=>{const p=window.innerHeight/2,_=window.innerWidth/2,v=h.clientX-_,m=h.clientY-p;o.value=`${v/-260}deg`,a.value=`${m/180}deg`};Tn(()=>{l(),window.addEventListener("resize",l)}),Vr(()=>{window.removeEventListener("resize",l)});const u=xt(""),f=xt("");return Xi(()=>t.title,()=>{u.value="intro",f.value="intro-page",setTimeout(()=>{u.value="",f.value=""},500)}),xt(!1),(h,p)=>(Ge(),ht("div",{class:Xn(["box-container","border-all",{swing:ot(e).status.swing}]),onMousemove:c},[r.value?(Ge(),ht("div",Ny,[Le("div",Fy,[Le("h1",{class:Xn(u.value)},sn(t.title),3)]),Le("div",Oy,[Io(h.$slots,"default",{},void 0)]),Le("nav",ky,[(Ge(!0),ht(Dt,null,wr(t.links,(_,v)=>(Ge(),Wt(hc,{class:"link",key:v,"to-name":_.nameLink,content:_.name},null,8,["to-name","content"]))),128))])])):(Ge(),ht("div",Py,[Le("div",Dy,[Le("div",Ly,[Le("h1",{class:Xn(u.value)},sn(t.title),3)]),Le("div",Iy,[Le("nav",Uy,[(Ge(!0),ht(Dt,null,wr(t.links,(_,v)=>(Ge(),Wt(hc,{class:"link",key:v,"to-name":_.nameLink,content:_.name},null,8,["to-name","content"]))),128))])])]),Le("div",{class:Xn(["right",{"intro-page":f.value}])},[Io(h.$slots,"default",{},void 0)],2)]))],34))}}),zy=Ut(By,[["__scopeId","data-v-9fbccafd"]]),Hy=Mt({__name:"MainPage",setup(n){const e=xt(""),t=[{name:"Home",nameLink:"home"},{name:"Projetos",nameLink:"Meus projetos"},{name:"Contatos",nameLink:"Estou por ai"},{name:"Configurações",nameLink:"Configurações"}];return Tn(()=>{e.value=document.title}),Cc(()=>{e.value=document.title}),(i,r)=>(Ge(),Wt(zy,{title:e.value,links:t},{default:Hr(()=>[mt(ot(fa))]),_:1},8,["title"]))}}),Vy={class:"text-to-copy"},Gy={class:"text-to-copy"},Wy={class:"message"},Xy=Mt({__name:"CopyText",props:{content:{},textToCopy:{}},setup(n){const e=n,t=xt(!1),i=xt(""),r=()=>{navigator.clipboard.writeText(e.textToCopy),i.value="Copiado",t.value=!1,setTimeout(()=>{i.value=""},1300)},s=o=>t.value=o;return(o,a)=>(Ge(),ht("div",{class:"text-to-copy-container",onMouseenter:a[0]||(a[0]=l=>s(!0)),onMouseleave:a[1]||(a[1]=l=>s(!1))},[Le("p",null,sn(e.content),1),Ar(Le("div",Vy,[Le("p",null,sn(e.textToCopy),1),Le("button",{onClick:r},"Copiar")],512),[[Fo,t.value&&!i.value]]),Ar(Le("div",Gy,[Le("p",Wy,sn(i.value),1)],512),[[Fo,i.value]])],32))}}),$y=Ut(Xy,[["__scopeId","data-v-17d92279"]]),qy={class:"contactme-container"},Yy=["href"],jy="vinicius_dev@hotmail.com",Ky=Mt({__name:"ContactMe",setup(n){const i=[{name:"Linkedin",link:"https://www.linkedin.com/in/vinicius-dev-junior/"},{name:"Github",link:"https://github.com/vinicius-mns"}];return(r,s)=>(Ge(),ht("div",qy,[(Ge(),ht(Dt,null,wr(i,(o,a)=>Le("a",{key:a,href:o.link,target:"_blank"},sn(o.name),9,Yy)),64)),mt($y,{content:"Email","text-to-copy":jy,class:"email"})]))}}),Zy=Ut(Ky,[["__scopeId","data-v-2151312f"]]),yi=n=>(ea("data-v-99e1ca40"),n=n(),ta(),n),Jy={class:"item-container"},Qy=yi(()=>Le("div",{class:"empty horizontal top-left"},null,-1)),eb=yi(()=>Le("div",{class:"empty horizontal top-right"},null,-1)),tb=yi(()=>Le("div",{class:"empty horizontal bottom-left"},null,-1)),nb=yi(()=>Le("div",{class:"empty horizontal bottom-right"},null,-1)),ib=yi(()=>Le("div",{class:"empty vertical left-top"},null,-1)),rb=yi(()=>Le("div",{class:"empty vertical left-bottom"},null,-1)),sb=yi(()=>Le("div",{class:"empty vertical right-top"},null,-1)),ob=yi(()=>Le("div",{class:"empty vertical right-bottom"},null,-1)),ab=Mt({__name:"LinkBase2",props:{toName:{},content:{},params:{}},setup(n){const e=n;return(t,i)=>{const r=Hh("RouterLink");return Ge(),Wt(r,{class:"link-2",to:{name:e.toName,params:e.params}},{default:Hr(()=>[Le("div",Jy,[Le("h2",null,sn(e.content),1)]),Qy,eb,tb,nb,ib,rb,sb,ob]),_:1},8,["to"])}}}),lb=Ut(ab,[["__scopeId","data-v-99e1ca40"]]),cb=["name","min","max"],ub=Mt({__name:"RangeImput",props:{initValue:{},name:{},limit:{}},emits:["emitValue"],setup(n,{emit:e}){const t=n,i=e,r=xt(t.initValue);return Wh(()=>{i("emitValue",Number(r.value))}),(s,o)=>Ar((Ge(),ht("input",{type:"range","onUpdate:modelValue":o[0]||(o[0]=a=>r.value=a),name:t.name,min:t.limit.min,max:t.limit.max,class:"range"},null,8,cb)),[[zg,r.value]])}}),rp=Ut(ub,[["__scopeId","data-v-7cb08e7c"]]),fb={class:"header-container"},hb={class:"header-space"},db=Mt({__name:"HeaderBase",props:{title:{}},setup(n){return(e,t)=>(Ge(),ht("header",fb,[Le("div",hb,[Io(e.$slots,"default",{},void 0)])]))}}),pb=Ut(db,[["__scopeId","data-v-a7b62774"]]),mb=n=>(ea("data-v-81360a2a"),n=n(),ta(),n),gb={class:"list-main-container"},_b={class:"range-container"},vb=mb(()=>Le("p",null,"Colunas:",-1)),xb={class:"projects-list"},Mb=Mt({__name:"ColumnsList",props:{components:{}},setup(n){const e=n,t=xt(!1),i=xt(4),r=Bt(()=>{const o=Array.from({length:i.value},()=>[]),a=e.components;for(let l=0;l<a.length;l+=1){const c=l%i.value;o[c].push(a[l])}return o}),s=()=>{(t.value=window.innerWidth<768)&&(t.value=!0,i.value=1)};return Tn(s),Cc(s),(o,a)=>(Ge(),ht("div",gb,[t.value?Cr("",!0):(Ge(),Wt(pb,{key:0,title:"",class:"list-header"},{default:Hr(()=>[Le("div",_b,[vb,Le("p",null,"["+sn(i.value)+"]",1),mt(rp,{class:"range-imput",limit:{min:1,max:6},"init-value":i.value,name:"project-columns",onEmitValue:a[0]||(a[0]=l=>i.value=l)},null,8,["init-value"])])]),_:1})),Le("div",xb,[(Ge(!0),ht(Dt,null,wr(r.value,(l,c)=>(Ge(),ht("div",{class:"projects-column",key:c},[(Ge(!0),ht(Dt,null,wr(l,(u,f)=>(Ge(),Wt(wm(u.component),ad({class:"component",key:f},u.props),null,16))),128))]))),128))])]))}}),Sb=Ut(Mb,[["__scopeId","data-v-81360a2a"]]),Eb=[{id:"1",title:"Projeto 1",content:"Descrição do projeto 1"},{id:"2",title:"Projeto 2",content:"Descrição do projeto 2"},{id:"3",title:"Template",content:`# Template de Projeto
...
1. **Clone o repositório**: Instruções para clonar o repositório do projeto.
   ...
   \`\`\``},{id:"4",title:"projeto 4",content:"Descrição do projeto 4"}],ih={projects:Eb},sp=gd("api falsa",()=>({projects:()=>({getProjects:()=>ih.projects,getProjectId:i=>ih.projects.find(s=>s.id===i)})})),yb={class:"my-projects-container"},bb=Mt({__name:"MyPojects",setup(n){const e=wd(),t=sp(),i=(o,a)=>({component:Ts(lb),props:{toName:"project",content:o,params:{id:a}}}),r=xt([]),s=Bt(()=>e.name==="Meus projetos");return Tn(()=>{const a=t.projects().getProjects().map(l=>i(l.title,l.id));r.value=a}),(o,a)=>(Ge(),ht("div",yb,[s.value?(Ge(),Wt(Sb,{key:0,components:r.value},null,8,["components"])):Cr("",!0),mt(ot(fa))]))}}),Tb=Ut(bb,[["__scopeId","data-v-42634db5"]]),Ab={class:"checkbox-container"},wb={class:"my-checkbox"},Rb={class:"check"},Cb=Mt({__name:"CheckboxBase",props:{check:{type:Boolean},content:{}},emits:["emit-check"],setup(n,{emit:e}){const t=n,i=e,r=xt(t.check);return Wh(()=>{i("emit-check",r.value)}),(s,o)=>(Ge(),ht("label",Ab,[Ar(Le("input",{class:"checkbox",type:"checkbox",name:"exemploCheckbox",value:"sim","onUpdate:modelValue":o[0]||(o[0]=a=>r.value=a)},null,512),[[Hg,r.value]]),Le("div",wb,[Ar(Le("div",Rb,null,512),[[Fo,r.value]])]),Le("p",null,sn(t.content),1)]))}}),il=Ut(Cb,[["__scopeId","data-v-0cc3e6c5"]]),Pb={class:"range-container"},Db={class:"range-title"},Lb=Mt({__name:"FloatRange",props:{value:{},name:{},limit:{}},emits:["emitValue"],setup(n,{emit:e}){const t=n,i=e,r=Yt({show:!1,value:0,name:"default",limit:{min:0,max:100}}),s=a=>{r.show=a},o=a=>{r.value=a,i("emitValue",a)};return Tn(()=>{r.value=t.value,r.name=t.name,r.limit=t.limit}),(a,l)=>(Ge(),ht("div",{class:"float-range-container",onMouseenter:l[1]||(l[1]=c=>s(!0)),onMouseleave:l[2]||(l[2]=c=>s(!1))},[Le("p",null,sn(r.name),1),Ar(Le("div",Pb,[Le("div",Db,[Le("h2",null,sn(r.name),1),Le("p",null,sn([r.value]),1)]),mt(rp,{"init-value":t.value,name:t.name,limit:t.limit,onEmitValue:l[0]||(l[0]=c=>o(c))},null,8,["init-value","name","limit"])],512),[[Fo,r.show]])],32))}}),Ib=Ut(Lb,[["__scopeId","data-v-c85aaee7"]]),Ub={class:"config-page"},Nb={class:"config-options-container"},Fb=Mt({__name:"ConfigPage",setup(n){const{trackBall:e,darkMode:t,swing:i,opacity:r,mobile:s}=Ls();return(o,a)=>(Ge(),ht("div",Ub,[Le("div",Nb,[mt(il,{class:"option",check:ot(t).status.dark,content:"Modo escuro",onEmitCheck:a[0]||(a[0]=l=>ot(t).metod.darkMode(l))},null,8,["check"]),mt(Ib,{class:"option",value:ot(r).status.opacity,name:"Opacidade",limit:{min:0,max:100},onEmitValue:a[1]||(a[1]=l=>ot(r).metod.setOpacity(l))},null,8,["value"]),ot(s).status.isMobileSize?Cr("",!0):(Ge(),Wt(il,{key:0,class:"option",check:ot(e).status.show,content:"Track ball",onEmitCheck:a[2]||(a[2]=l=>ot(e).metod.show(l))},null,8,["check"])),ot(s).status.isMobileSize?Cr("",!0):(Ge(),Wt(il,{key:1,class:"option",check:ot(i).status.swing,content:"Balanço",onEmitCheck:a[3]||(a[3]=l=>ot(i).metod.swingMode(l))},null,8,["check"]))])]))}}),Ob=Ut(Fb,[["__scopeId","data-v-047997c3"]]);function $c(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let Qi=$c();function op(n){Qi=n}const ap=/[&<>"']/,kb=new RegExp(ap.source,"g"),lp=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Bb=new RegExp(lp.source,"g"),zb={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},rh=n=>zb[n];function rn(n,e){if(e){if(ap.test(n))return n.replace(kb,rh)}else if(lp.test(n))return n.replace(Bb,rh);return n}const Hb=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Vb(n){return n.replace(Hb,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Gb=/(^|[^\[])\^/g;function ct(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const i={replace:(r,s)=>{let o=typeof s=="string"?s:s.source;return o=o.replace(Gb,"$1"),t=t.replace(r,o),i},getRegex:()=>new RegExp(t,e)};return i}function sh(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const fs={exec:()=>null};function oh(n,e){const t=n.replace(/\|/g,(s,o,a)=>{let l=!1,c=o;for(;--c>=0&&a[c]==="\\";)l=!l;return l?"|":" |"}),i=t.split(/ \|/);let r=0;if(i[0].trim()||i.shift(),i.length>0&&!i[i.length-1].trim()&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(/\\\|/g,"|");return i}function mo(n,e,t){const i=n.length;if(i===0)return"";let r=0;for(;r<i&&n.charAt(i-r-1)===e;)r++;return n.slice(0,i-r)}function Wb(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let i=0;i<n.length;i++)if(n[i]==="\\")i++;else if(n[i]===e[0])t++;else if(n[i]===e[1]&&(t--,t<0))return i;return-1}function ah(n,e,t,i){const r=e.href,s=e.title?rn(e.title):null,o=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){i.state.inLink=!0;const a={type:"link",raw:t,href:r,title:s,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,a}return{type:"image",raw:t,href:r,title:s,text:rn(o)}}function Xb(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const i=t[1];return e.split(`
`).map(r=>{const s=r.match(/^\s+/);if(s===null)return r;const[o]=s;return o.length>=i.length?r.slice(i.length):r}).join(`
`)}class Vo{constructor(e){at(this,"options");at(this,"rules");at(this,"lexer");this.options=e||Qi}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const i=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?i:mo(i,`
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const i=t[0],r=Xb(i,t[3]||"");return{type:"code",raw:i,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:r}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let i=t[2].trim();if(/#$/.test(i)){const r=mo(i,"#");(this.options.pedantic||!r||/ $/.test(r))&&(i=r.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:i,tokens:this.lexer.inline(i)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){const i=mo(t[0].replace(/^ *>[ \t]?/gm,""),`
...
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:i,tokens:this.lexer.inline(i)}}}text(e){const t=this.rules.block.text.exec(e);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){const t=this.rules.inline.escape.exec(e);if(t)return{type:"escape",raw:t[0],text:rn(t[1])}}tag(e){const t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){const t=this.rules.inline.link.exec(e);if(t){const i=t[2].trim();if(!this.options.pedantic&&/^</.test(i)){if(!/>$/.test(i))return;const o=mo(i.slice(0,-1),"\\");if((i.length-o.length)%2===0)return}else{const o=Wb(t[2],"()");if(o>-1){const l=(t[0].indexOf("!")===0?5:4)+t[1].length+o;t[2]=t[2].substring(0,o),t[0]=t[0].substring(0,l).trim(),t[3]=""}}let r=t[2],s="";if(this.options.pedantic){const o=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r);o&&(r=o[1],s=o[3])}else s=t[3]?t[3].slice(1,-1):"";return r=r.trim(),/^</.test(r)&&(this.options.pedantic&&!/>$/.test(i)?r=r.slice(1):r=r.slice(1,-1)),ah(t,{href:r&&r.replace(this.rules.inline.anyPunctuation,"$1"),title:s&&s.replace(this.rules.inline.anyPunctuation,"$1")},t[0],this.lexer)}}reflink(e,t){let i;if((i=this.rules.inline.reflink.exec(e))||(i=this.rules.inline.nolink.exec(e))){const r=(i[2]||i[1]).replace(/\s+/g," "),s=t[r.toLowerCase()];if(!s){const o=i[0].charAt(0);return{type:"text",raw:o,text:o}}return ah(i,s,i[0],this.lexer)}}emStrong(e,t,i=""){let r=this.rules.inline.emStrongLDelim.exec(e);if(!r||r[3]&&i.match(/[\p{L}\p{N}]/u))return;if(!(r[1]||r[2]||"")||!i||this.rules.inline.punctuation.exec(i)){const o=[...r[0]].length-1;let a,l,c=o,u=0;const f=r[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(f.lastIndex=0,t=t.slice(-1*e.length+o);(r=f.exec(t))!=null;){if(a=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!a)continue;if(l=[...a].length,r[3]||r[4]){c+=l;continue}else if((r[5]||r[6])&&o%3&&!((o+l)%3)){u+=l;continue}if(c-=l,c>0)continue;l=Math.min(l,l+c+u);const h=[...r[0]][0].length,p=e.slice(0,o+r.index+h+l);if(Math.min(o,l)%2){const v=p.slice(1,-1);return{type:"em",raw:p,text:v,tokens:this.lexer.inlineTokens(v)}}const _=p.slice(2,-2);return{type:"strong",raw:p,text:_,tokens:this.lexer.inlineTokens(_)}}}}codespan(e){const t=this.rules.inline.code.exec(e);if(t){let i=t[2].replace(/\n/g," ");const r=/[^ ]/.test(i),s=/^ /.test(i)&&/ $/.test(i);return r&&s&&(i=i.substring(1,i.length-1)),i=rn(i,!0),{type:"codespan",raw:t[0],text:i}}}br(e){const t=this.rules.inline.br.exec(e);if(t)return{type:"br",raw:t[0]}}del(e){const t=this.rules.inline.del.exec(e);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){const t=this.rules.inline.autolink.exec(e);if(t){let i,r;return t[2]==="@"?(i=rn(t[1]),r="mailto:"+i):(i=rn(t[1]),r=i),{type:"link",raw:t[0],text:i,href:r,tokens:[{type:"text",raw:i,text:i}]}}}url(e){var i;let t;if(t=this.rules.inline.url.exec(e)){let r,s;if(t[2]==="@")r=rn(t[0]),s="mailto:"+r;else{let o;do o=t[0],t[0]=((i=this.rules.inline._backpedal.exec(t[0]))==null?void 0:i[0])??"";while(o!==t[0]);r=rn(t[0]),t[1]==="www."?s="http://"+t[0]:s=t[0]}return{type:"link",raw:t[0],text:r,href:s,tokens:[{type:"text",raw:r,text:r}]}}}inlineText(e){const t=this.rules.inline.text.exec(e);if(t){let i;return this.lexer.state.inRawBlock?i=t[0]:i=rn(t[0]),{type:"text",raw:t[0],text:i}}}}const $b=/^(?: *(?:\n|$))+/,qb=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Yb=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Is=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,jb=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,cp=/(?:[*+-]|\d{1,9}[.)])/,up=ct(/^(?!bull )((?:.|\n(?!\s*?\n|bull ))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,cp).getRegex(),qc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Kb=/^[^\n]+/,Yc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Zb=ct(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",Yc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Jb=ct(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,cp).getRegex(),ga="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",jc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Qb=ct("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",jc).replace("tag",ga).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),fp=ct(qc).replace("hr",Is).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ga).getRegex(),eT=ct(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",fp).getRegex(),Kc={blockquote:eT,code:qb,def:Zb,fences:Yb,heading:jb,hr:Is,html:Qb,lheading:up,list:Jb,newline:$b,paragraph:fp,table:fs,text:Kb},lh=ct("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Is).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ga).getRegex(),tT={...Kc,table:lh,paragraph:ct(qc).replace("hr",Is).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",lh).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ga).getRegex()},nT={...Kc,html:ct(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",jc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:fs,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ct(qc).replace("hr",Is).replace("heading",` *#{1,6} *[^
]`).replace("lheading",up).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},hp=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,iT=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,dp=/^( {2,}|\\)\n(?!\s*$)/,rT=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Us="\\p{P}\\p{S}",sT=ct(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,Us).getRegex(),oT=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,aT=ct(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,Us).getRegex(),lT=ct("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,Us).getRegex(),cT=ct("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,Us).getRegex(),uT=ct(/\\([punct])/,"gu").replace(/punct/g,Us).getRegex(),fT=ct(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),hT=ct(jc).replace("(?:-->|$)","-->").getRegex(),dT=ct("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",hT).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Go=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,pT=ct(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",Go).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),pp=ct(/^!?\[(label)\]\[(ref)\]/).replace("label",Go).replace("ref",Yc).getRegex(),mp=ct(/^!?\[(ref)\](?:\[\])?/).replace("ref",Yc).getRegex(),mT=ct("reflink|nolink(?!\\()","g").replace("reflink",pp).replace("nolink",mp).getRegex(),Zc={_backpedal:fs,anyPunctuation:uT,autolink:fT,blockSkip:oT,br:dp,code:iT,del:fs,emStrongLDelim:aT,emStrongRDelimAst:lT,emStrongRDelimUnd:cT,escape:hp,link:pT,nolink:mp,punctuation:sT,reflink:pp,reflinkSearch:mT,tag:dT,text:rT,url:fs},gT={...Zc,link:ct(/^!?\[(label)\]\((.*?)\)/).replace("label",Go).getRegex(),reflink:ct(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Go).getRegex()},dc={...Zc,escape:ct(hp).replace("])","~|])").getRegex(),url:ct(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},_T={...dc,br:ct(dp).replace("{2,}","*").getRegex(),text:ct(dc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},go={normal:Kc,gfm:tT,pedantic:nT},ts={normal:Zc,gfm:dc,breaks:_T,pedantic:gT};class Dn{constructor(e){at(this,"tokens");at(this,"options");at(this,"state");at(this,"tokenizer");at(this,"inlineQueue");this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Qi,this.options.tokenizer=this.options.tokenizer||new Vo,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const t={block:go.normal,inline:ts.normal};this.options.pedantic?(t.block=go.pedantic,t.inline=ts.pedantic):this.options.gfm&&(t.block=go.gfm,this.options.breaks?t.inline=ts.breaks:t.inline=ts.gfm),this.tokenizer.rules=t}static get rules(){return{block:go,inline:ts}}static lex(e,t){return new Dn(t).lex(e)}static lexInline(e,t){return new Dn(t).inlineTokens(e)}lex(e){e=e.replace(/\r\n|\r/g,`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return"<br>"}del(e){return`<del>${e}</del>`}link(e,t,i){const r=sh(e);if(r===null)return i;e=r;let s='<a href="'+e+'"';return t&&(s+=' title="'+t+'"'),s+=">"+i+"</a>",s}image(e,t,i){const r=sh(e);if(r===null)return i;e=r;let s=`<img src="${e}" alt="${i}"`;return t&&(s+=` title="${t}"`),s+=">",s}text(e){return e}}class Jc{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,i){return""+i}image(e,t,i){return""+i}br(){return""}}class Ln{constructor(e){at(this,"options");at(this,"renderer");at(this,"textRenderer");this.options=e||Qi,this.options.renderer=this.options.renderer||new Wo,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Jc}static parse(e,t){return new Ln(t).parse(e)}static parseInline(e,t){return new Ln(t).parseInline(e)}parse(e,t=!0){let i="";for(let r=0;r<e.length;r++){const s=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[s.type]){const o=s,a=this.options.extensions.renderers[o.type].call({parser:this},o);if(a!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(o.type)){i+=a||"";continue}}switch(s.type){case"space":continue;case"hr":{i+=this.renderer.hr();continue}case"heading":{const o=s;i+=this.renderer.heading(this.parseInline(o.tokens),o.depth,Vb(this.parseInline(o.tokens,this.textRenderer)));continue}case"code":{const o=s;i+=this.renderer.code(o.text,o.lang,!!o.escaped);continue}case"table":{const o=s;let a="",l="";for(let u=0;u<o.header.length;u++)l+=this.renderer.tablecell(this.parseInline(o.header[u].tokens),{header:!0,align:o.align[u]});a+=this.renderer.tablerow(l);let c="";for(let u=0;u<o.rows.length;u++){const f=o.rows[u];l="";for(let h=0;h<f.length;h++)l+=this.renderer.tablecell(this.parseInline(f[h].tokens),{header:!1,align:o.align[h]});c+=this.renderer.tablerow(l)}i+=this.renderer.table(a,c);continue}case"blockquote":{const o=s,a=this.parse(o.tokens);i+=this.renderer.blockquote(a);continue}case"list":{const o=s,a=o.ordered,l=o.start,c=o.loose;let u="";for(let f=0;f<o.items.length;f++){const h=o.items[f],p=h.checked,_=h.task;let v="";if(h.task){const m=this.renderer.checkbox(!!p);c?h.tokens.length>0&&h.tokens[0].type==="paragraph"?(h.tokens[0].text=m+" "+h.tokens[0].text,h.tokens[0].tokens&&h.tokens[0].tokens.length>0&&h.tokens[0].tokens[0].type==="text"&&(h.tokens[0].tokens[0].text=m+" "+h.tokens[0].tokens[0].text)):h.tokens.unshift({type:"text",text:m+" "}):v+=m+" "}v+=this.parse(h.tokens,c),u+=this.renderer.listitem(v,_,!!p)}i+=this.renderer.list(u,a,l);continue}case"html":{const o=s;i+=this.renderer.html(o.text,o.block);continue}case"paragraph":{const o=s;i+=this.renderer.paragraph(this.parseInline(o.tokens));continue}case"text":{let o=s,a=o.tokens?this.parseInline(o.tokens):o.text;for(;r+1<e.length&&e[r+1].type==="text";)o=e[++r],a+=`
`+(o.tokens?this.parseInline(o.tokens):o.text);i+=t?this.renderer.paragraph(a):a;continue}default:{const o='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(o),"";throw new Error(o)}}}return i}parseInline(e,t){t=t||this.renderer;let i="";for(let r=0;r<e.length;r++){const s=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[s.type]){const o=this.options.extensions.renderers[s.type].call({parser:this},s);if(o!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){i+=o||"";continue}}switch(s.type){case"escape":{const o=s;i+=t.text(o.text);break}case"html":{const o=s;i+=t.html(o.text);break}case"link":{const o=s;i+=t.link(o.href,o.title,this.parseInline(o.tokens,t));break}case"image":{const o=s;i+=t.image(o.href,o.title,o.text);break}case"strong":{const o=s;i+=t.strong(this.parseInline(o.tokens,t));break}case"em":{const o=s;i+=t.em(this.parseInline(o.tokens,t));break}case"codespan":{const o=s;i+=t.codespan(o.text);break}case"br":{i+=t.br();break}case"del":{const o=s;i+=t.del(this.parseInline(o.tokens,t));break}case"text":{const o=s;i+=t.text(o.text);break}default:{const o='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(o),"";throw new Error(o)}}}return i}}class hs{constructor(e){at(this,"options");this.options=e||Qi}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}}at(hs,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var Ji,pc,gp;class vT{constructor(...e){lu(this,Ji);at(this,"defaults",$c());at(this,"options",this.setOptions);at(this,"parse",Os(this,Ji,pc).call(this,Dn.lex,Ln.parse));at(this,"parseInline",Os(this,Ji,pc).call(this,Dn.lexInline,Ln.parseInline));at(this,"Parser",Ln);at(this,"Renderer",Wo);at(this,"TextRenderer",Jc);at(this,"Lexer",Dn);at(this,"Tokenizer",Vo);at(this,"Hooks",hs);this.use(...e)}walkTokens(e,t){var r,s;let i=[];for(const o of e)switch(i=i.concat(t.call(this,o)),o.type){case"table":{const a=o;for(const l of a.header)i=i.concat(this.walkTokens(l.tokens,t));for(const l of a.rows)for(const c of l)i=i.concat(this.walkTokens(c.tokens,t));break}case"list":{const a=o;i=i.concat(this.walkTokens(a.items,t));break}default:{const a=o;(s=(r=this.defaults.extensions)==null?void 0:r.childTokens)!=null&&s[a.type]?this.defaults.extensions.childTokens[a.type].forEach(l=>{const c=a[l].flat(1/0);i=i.concat(this.walkTokens(c,t))}):a.tokens&&(i=i.concat(this.walkTokens(a.tokens,t)))}}return i}use(...e){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(i=>{const r={...i};if(r.async=this.defaults.async||r.async||!1,i.extensions&&(i.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if("renderer"in s){const o=t.renderers[s.name];o?t.renderers[s.name]=function(...a){let l=s.renderer.apply(this,a);return l===!1&&(l=o.apply(this,a)),l}:t.renderers[s.name]=s.renderer}if("tokenizer"in s){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const o=t[s.level];o?o.unshift(s.tokenizer):t[s.level]=[s.tokenizer],s.start&&(s.level==="block"?t.startBlock?t.startBlock.push(s.start):t.startBlock=[s.start]:s.level==="inline"&&(t.startInline?t.startInline.push(s.start):t.startInline=[s.start]))}"childTokens"in s&&s.childTokens&&(t.childTokens[s.name]=s.childTokens)}),r.extensions=t),i.renderer){const s=this.defaults.renderer||new Wo(this.defaults);for(const o in i.renderer){if(!(o in s))throw new Error(`renderer '${o}' does not exist`);if(o==="options")continue;const a=o,l=i.renderer[a],c=s[a];s[a]=(...u)=>{let f=l.apply(s,u);return f===!1&&(f=c.apply(s,u)),f||""}}r.renderer=s}if(i.tokenizer){const s=this.defaults.tokenizer||new Vo(this.defaults);for(const o in i.tokenizer){if(!(o in s))throw new Error(`tokenizer '${o}' does not exist`);if(["options","rules","lexer"].includes(o))continue;const a=o,l=i.tokenizer[a],c=s[a];s[a]=(...u)=>{let f=l.apply(s,u);return f===!1&&(f=c.apply(s,u)),f}}r.tokenizer=s}if(i.hooks){const s=this.defaults.hooks||new hs;for(const o in i.hooks){if(!(o in s))throw new Error(`hook '${o}' does not exist`);if(o==="options")continue;const a=o,l=i.hooks[a],c=s[a];hs.passThroughHooks.has(o)?s[a]=u=>{if(this.defaults.async)return Promise.resolve(l.call(s,u)).then(h=>c.call(s,h));const f=l.call(s,u);return c.call(s,f)}:s[a]=(...u)=>{let f=l.apply(s,u);return f===!1&&(f=c.apply(s,u)),f}}r.hooks=s}if(i.walkTokens){const s=this.defaults.walkTokens,o=i.walkTokens;r.walkTokens=function(a){let l=[];return l.push(o.call(this,a)),s&&(l=l.concat(s.call(this,a))),l}}this.defaults={...this.defaults,...r}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return Dn.lex(e,t??this.defaults)}parser(e,t){return Ln.parse(e,t??this.defaults)}}Ji=new WeakSet,pc=function(e,t){return(i,r)=>{const s={...r},o={...this.defaults,...s};this.defaults.async===!0&&s.async===!1&&(o.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),o.async=!0);const a=Os(this,Ji,gp).call(this,!!o.silent,!!o.async);if(typeof i>"u"||i===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof i!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));if(o.hooks&&(o.hooks.options=o),o.async)return Promise.resolve(o.hooks?o.hooks.preprocess(i):i).then(l=>e(l,o)).then(l=>o.hooks?o.hooks.processAllTokens(l):l).then(l=>o.walkTokens?Promise.all(this.walkTokens(l,o.walkTokens)).then(()=>l):l).then(l=>t(l,o)).then(l=>o.hooks?o.hooks.postprocess(l):l).catch(a);try{o.hooks&&(i=o.hooks.preprocess(i));let l=e(i,o);o.hooks&&(l=o.hooks.processAllTokens(l)),o.walkTokens&&this.walkTokens(l,o.walkTokens);let c=t(l,o);return o.hooks&&(c=o.hooks.postprocess(c)),c}catch(l){return a(l)}}},gp=function(e,t){return i=>{if(i.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+rn(i.message+"",!0)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(i);throw i}};const Zi=new vT;function it(n,e){return Zi.parse(n,e)}it.options=it.setOptions=function(n){return Zi.setOptions(n),it.defaults=Zi.defaults,op(it.defaults),it};it.getDefaults=$c;it.defaults=Qi;it.use=function(...n){return Zi.use(...n),it.defaults=Zi.defaults,op(it.defaults),it};it.walkTokens=function(n,e){return Zi.walkTokens(n,e)};it.parseInline=Zi.parseInline;it.Parser=Ln;it.parser=Ln.parse;it.Renderer=Wo;it.TextRenderer=Jc;it.Lexer=Dn;it.lexer=Dn.lex;it.Tokenizer=Vo;it.Hooks=hs;it.parse=it;it.options;it.setOptions;it.use;it.walkTokens;it.parseInline;Ln.parse;Dn.lex;const xT=["innerHTML"],MT=Mt({__name:"MarkdownAtom",props:{content:{}},setup(n){const e=n;return it.setOptions({breaks:!0}),(t,i)=>(Ge(),ht("div",{innerHTML:ot(it)(e.content)},null,8,xT))}}),ST={},_p=n=>(ea("data-v-8f707370"),n=n(),ta(),n),ET={class:"button-close"},yT=_p(()=>Le("div",{class:"cross one"},null,-1)),bT=_p(()=>Le("div",{class:"cross two"},null,-1)),TT=[yT,bT];function AT(n,e){return Ge(),ht("button",ET,TT)}const wT=Ut(ST,[["render",AT],["__scopeId","data-v-8f707370"]]),RT={class:"my-projects-container"},CT={class:"header"},PT={class:"content"},DT=Mt({__name:"ProjectPage",setup(n){const{opacity:e}=Ls(),t=nv(),i=sp(),r=wd().params.id,s=xt({content:""}),o=xt(0),a=h=>{document.title=h.title},l=h=>{s.value.content=h.content},c=()=>{e.status.opacity<=32||e.metod.setOpacity(32)},u=()=>{e.metod.setOpacity(o.value)},f=()=>{t.push({name:"Meus projetos"})};return Tn(()=>{const h=i.projects().getProjectId(r);h&&(o.value=e.status.opacity,c(),a(h),l(h))}),Vr(u),(h,p)=>(Ge(),ht("div",RT,[Le("header",CT,[mt(wT,{onClick:f})]),Le("div",PT,[mt(MT,{class:"markdown",content:s.value.content},null,8,["content"])])]))}}),LT=Ut(DT,[["__scopeId","data-v-5d377b91"]]),vp=ev({history:__("./"),routes:[{path:"/",name:"home",component:Cy},{path:"/main",name:"main",component:Hy,children:[{path:"contact",name:"Estou por ai",component:Zy,meta:{title:"Estou por ai"}},{path:"projects",name:"Meus projetos",component:Tb,children:[{path:"project/:id",name:"project",component:LT}]},{path:"config",name:"Configurações",component:Ob}]}]});vp.afterEach(n=>{const e=n.name;document.title=e});const Qc=Xg(My);Qc.use(qg());Qc.use(vp);Qc.mount("#app");
