...
import AboutMe from '../template/AboutMe.vue'
import MyPojects from '../template/MyPojects.vue'
import IdleAnimation from '../template/IdleAnimation.vue'
import ContactMe from '../template/ContactMe.vue'
